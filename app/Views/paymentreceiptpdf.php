...
<body>
  ...
  <div id='paymenttoast' style='border:4px solid rgb(132, 250, 132);border-radius:10px;position:absolute;top:10%;right:-380px;transition:0.5s;background-color:rgb(18, 155, 18);' class=' toast hide'>
...
<!---------------------add-toast-end------------------>
      ...
      <div class="row"><!-----top-bar--------------->
        ...
        <div class="row"><!----------main-navbar----------->
         ...
         <div id="receiptpdf" style="overflow:auto;" class="col-md-10 row justify-content-center"><!-----------main-dashboard------------------------->
                     ...
                     <?php if(isset($receipt)): ?>
                      <table class="table table-borderless">
                        ...
                        <tbody id="printreceipt">
                            <tr><td>பெயர்</td><td>:</td><td class='fw-bold'><?=$receipt->Membername?></td></tr>
                            <tr><td>குடும்ப உறுப்பினர் எண்:</td><td>:</td><td class='fw-bold'><?=$receipt->Familymembershipid?></td></tr> 
                            <tr><td>முகவரி</td><td>:</td><td class="fw-bold"><?=$receipt->Membertaluk?></td></tr>
                            <tr><td>பணம் செலுத்திய முறை</td><td>:</td><td class="fw-bold"><?=$receipt->paymenttype?></td></tr>
                            <tr><td>பணம் செலுத்திய தேதி</td><td>:</td><td class="fw-bold"><?=$receipt->paymentdate?></td></tr>
                            <tr><td>பணம் செலுத்திய வங்கியின் பெயர்</td><td>:</td><td class="fw-bold">
                            <?php
                            ...
                            <tr><td>வங்கி பரிவர்த்தனை எண்</td><td>:</td><td class="fw-bold">
                            <?php
                            ...
                            ?></td></tr>
                            <tr><td>காசோலை எண்:</td><td>:</td><td class="fw-bold">
                            <?php
                            ...
                            ?></td></tr>
                            <tr><td>UPI பரிவர்த்தனை எண்</td><td>:</td><td class="fw-bold">
                            <?php
                            ...
                            ?></td></tr>
                            <tr><td>நன்கொடையாக பெறப்பட்ட தொகை</td><td>:</td><td class="fw-bold"><?=$receipt->paidamount?></td></tr>
                            <tr><td colspan="3" class="py-5" style="text-align:right;">மேலாளர் கையொப்பம்/Manager Signature</td></tr>
