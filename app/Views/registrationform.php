...
<body>
    ...
    <script>
        ...
        if (document.getElementById('cur_nri_block').style.display !== 'none') {
            if (field.name === 'cur_nri_country' && !field.value) {
                document.getElementById('cur_nri_countryerror').innerHTML = 'Please select country.';
            }
            if (field.name === 'cur_nri_state' && !field.value) {
                document.getElementById('cur_nri_stateerror').innerHTML = 'Please select state.';
            }
            if (field.name === 'cur_nri_city' && !field.value) {
                document.getElementById('cur_nri_cityerror').innerHTML = 'Please select city.';
            }
        }
