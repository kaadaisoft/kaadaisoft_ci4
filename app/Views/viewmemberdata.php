        ...
        <table class="table table-bordered">
            ...
            <?php if(isset($coordinators) && isset($sno)):?>
                <?php $i=$sno + 1; foreach ($coordinators as $key => $value): ?> 
                    ...
                    <button onclick='showupdatecoordsmodal(<?=trim($value->Familymembershipid)?>)' style='width:30px;height:30px;outline:none;border:none;' class='updatecoord shadow-sm text-dark table-btn rounded-circle'><i class='fa-regular fa-pen-to-square'></i><span class='updatetooltip'>Update</span></button>
                    ...
                    <button data-bs-toggle = 'modal' data-bs-target='#viewCoordinatordata' onclick ="viewCoordinatordata('viewCoordinatordata?coord_id=<?=$value->Familymembershipid?>')" data-bs-toggle='tooltip' title='viewCoordinatordata' style='width:30px;height:30px;outline:none;border:none;' class='table-btn text-dark shadow-sm rounded-circle'><i class='fa-sharp fa-solid fa-eye'></i></button>
                    </td>
                    </tr>
                    <?php ++$i; endforeach;?>
                    <?php endif;?>
