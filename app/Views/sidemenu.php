...
<li class="nav-item"><a href="<?= base_url('id-card-benefits') ?>" data-page="id-card-benefits" class="text-decoration-none"><span class="icon icon-benefits"><i class="fa-solid fa-id-card"></i></span>&nbsp;&nbsp;<span class="fw-semibold">ID Card Benefits</span></a></li>
